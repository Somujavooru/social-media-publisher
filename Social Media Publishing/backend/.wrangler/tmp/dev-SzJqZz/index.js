...
// .wrangler/tmp/bundle-iDEmar/strip-cf-connecting-ip-header.js
...
oauthRouter.get("/:platform/connect", async (c) => {
  ...
  if (platform2 === "facebook" || platform2 === "instagram") {
    const clientId = platform2 === "facebook" ? c.env.FACEBOOK_CLIENT_ID : c.env.INSTAGRAM_CLIENT_ID;
    const redirectUri = encodeURIComponent(`http://localhost:8787/api/oauth/${platform2}/callback`);
...
oauthRouter.get("/:platform/callback", async (c) => {
  ...
  if (platform2 === "linkedin" || platform2 === "facebook" || platform2 === "instagram") {
    ...
    try {
      ...
      if (platform2 === "facebook" || platform2 === "instagram") {
        const clientId = platform2 === "facebook" ? c.env.FACEBOOK_CLIENT_ID : c.env.INSTAGRAM_CLIENT_ID;
        const clientSecret = platform2 === "facebook" ? c.env.FACEBOOK_CLIENT_SECRET : c.env.INSTAGRAM_CLIENT_SECRET;
        const redirectUri = `http://localhost:8787/api/oauth/${platform2}/callback`;
...
// .wrangler/tmp/bundle-iDEmar/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-iDEmar/middleware-loader.entry.ts
