...
// .wrangler/tmp/bundle-2zDGPg/strip-cf-connecting-ip-header.js
...
oauthRouter.get("/:platform/connect", async (c) => {
  ...
  if (platform2 === "facebook" || platform2 === "instagram") {
    ...
    const scopes = [
      "public_profile"
      // You must enable these in the Meta Developer Dashboard before uncommenting:
      // "pages_show_list",
      // "pages_manage_posts",
      ...
      if (platform2 === "facebook" || platform2 === "instagram") {
        ...
        if (platform2 === "facebook") {
          ...
          if (pagesData.data && pagesData.data.length > 0) {
            ...
            console.warn("No Facebook Pages found for user. Will proceed in MOCK mode for publishing.");
          }
        } else {
...
// .wrangler/tmp/bundle-2zDGPg/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-2zDGPg/middleware-loader.entry.ts
