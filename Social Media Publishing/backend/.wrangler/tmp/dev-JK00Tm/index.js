...
// .wrangler/tmp/bundle-uJHeyR/strip-cf-connecting-ip-header.js
  ...
  if (platform2 === "linkedin" || platform2 === "facebook" || platform2 === "instagram") {
    ...
    try {
      ...
      if (platform2 === "facebook" || platform2 === "instagram") {
        ...
        console.log("FACEBOOK_TOKEN_EXCHANGE_PAYLOAD:", payload);
        ...
        console.log("FACEBOOK_TOKEN_RESPONSE:", data);
...
// .wrangler/tmp/bundle-uJHeyR/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-uJHeyR/middleware-loader.entry.ts
