...
// .wrangler/tmp/bundle-GzdSdU/checked-fetch.js
...
// .wrangler/tmp/bundle-GzdSdU/strip-cf-connecting-ip-header.js
...
var AIService = class {
  ...
  async generateCaption(topic, platform) {
    const prompt = `Write an engaging, highly-optimized social media post about "${topic}" for ${platform}. Include relevant hashtags. Keep it concise and professional but dynamic.`;
...
// .wrangler/tmp/bundle-GzdSdU/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-GzdSdU/middleware-loader.entry.ts
