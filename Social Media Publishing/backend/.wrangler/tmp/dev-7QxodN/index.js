...
// .wrangler/tmp/bundle-RpESWk/strip-cf-connecting-ip-header.js
...
oauthRouter.get("/:platform/connect", async (c) => {
  ...
  if (platform2 === "facebook" || platform2 === "instagram") {
    ...
    const redirectUri = encodeURIComponent(platform2 === "facebook" && c.env.FACEBOOK_REDIRECT_URI ? c.env.FACEBOOK_REDIRECT_URI : `http://localhost:8787/api/oauth/${platform2}/callback`);
  ...
  if (platform2 === "linkedin" || platform2 === "facebook" || platform2 === "instagram") {
    ...
    try {
      ...
      if (platform2 === "facebook" || platform2 === "instagram") {
        ...
        const redirectUri = platform2 === "facebook" && c.env.FACEBOOK_REDIRECT_URI ? c.env.FACEBOOK_REDIRECT_URI : `http://localhost:8787/api/oauth/${platform2}/callback`;
...
// .wrangler/tmp/bundle-RpESWk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RpESWk/middleware-loader.entry.ts
