...
// .wrangler/tmp/bundle-ZiMlPe/strip-cf-connecting-ip-header.js
  ...
  if (platform2 === "linkedin" || platform2 === "facebook" || platform2 === "instagram") {
    ...
    try {
      ...
      if (platform2 === "facebook" || platform2 === "instagram") {
        ...
        console.log("RAW TOKEN RESPONSE:", raw2);
        const data = JSON.parse(raw2);
        if (!data.access_token) {
          console.error("TOKEN ERROR:", data);
          return new Response("Token missing", { status: 500 });
        }
        console.log("REAL TOKEN:", data.access_token);
        const userId = "mock-user";
...
// .wrangler/tmp/bundle-ZiMlPe/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZiMlPe/middleware-loader.entry.ts
