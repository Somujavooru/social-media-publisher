...
// .wrangler/tmp/bundle-cEZnif/strip-cf-connecting-ip-header.js
...
oauthRouter.get("/:platform/connect", async (c) => {
  ...
  if (platform2 === "facebook" || platform2 === "instagram") {
    ...
    const scope = platform2 === "facebook" ? encodeURIComponent("public_profile") : encodeURIComponent("instagram_basic,instagram_content_publish,pages_read_engagement");
    const state = crypto.randomUUID();
...
// .wrangler/tmp/bundle-cEZnif/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-cEZnif/middleware-loader.entry.ts
